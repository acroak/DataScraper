/*
Component to gather LeftSensor Information 
Step 3 in the report checklist.
*/
...
const LeftSensor = ({ navigation, route }) => {
    ...
    const submitAnswers = () => {
        ...
        console.log(answers);
        navigation.navigate("Right Sensor Inspection", { report1: route.params.report1, report2: route.params.report2, report3: answers });
    ...
    return (
        <Provider theme={ChecklistTheme}>
            <View style={ChecklistTheme.formContainer}>
                <Text variant="headlineMedium">Left Sensor Inspection:</Text>
